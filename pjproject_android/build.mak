export PJDIR := /home/sojus/src/meshnet/qaul.net_android/pjproject_android
...
export APP_CC := /home/sojus/src/android/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-gcc
export APP_CXX := /home/sojus/src/android/android-ndk-r8/toolchains/arm-linux-androideabi-4.4.3/prebuilt/linux-x86/bin/arm-linux-androideabi-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	 -I/home/sojus/src/android/android-ndk-r8/platforms/android-8/arch-arm/usr/include -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_CXXFLAGS :=  -I/home/sojus/src/android/android-ndk-r8/platforms/android-8/arch-arm/usr/include  -shared --sysroot=/home/sojus/src/android/android-ndk-r8/platforms/android-8/arch-arm
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	 -nostdlib -L/home/sojus/src/android/android-ndk-r8/platforms/android-8/arch-arm/usr/lib/
export APP_LDLIBS := -lpjsua-$(TARGET_NAME)\
	...
	$(APP_THIRD_PARTY_EXT)\
	-lpj-$(TARGET_NAME)\
	-lm  -lc -lgcc -lOpenSLES -llog -lgcc
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	 -I/home/sojus/src/android/android-ndk-r8/platforms/android-8/arch-arm/usr/include -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1
