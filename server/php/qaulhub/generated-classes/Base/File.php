...
abstract class File implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\FileTableMap';
    ...
    /**
     * Initializes internal state of Base\File object.
     */
     ...
     * @return     $this|\File The current object (for fluent API support)
     */
    ...
    public function setHash($v)
    {
        ...
        if ($this->hash !== $v) {
            $this->hash = $v;
            $this->modifiedColumns[FileTableMap::COL_HASH] = true;
        }
    ...
    public function setSuffix($v)
    {
        ...
        if ($this->suffix !== $v) {
            $this->suffix = $v;
            $this->modifiedColumns[FileTableMap::COL_SUFFIX] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[FileTableMap::COL_TIME] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[FileTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FileTableMap::translateFieldName('Hash', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hash = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FileTableMap::translateFieldName('Suffix', TableMap::TYPE_PHPNAME, $indexType)];
            $this->suffix = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FileTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : FileTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : FileTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\File'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_HASH)) {
            $modifiedColumns[':p' . $index++]  = 'HASH';
        }
        if ($this->isColumnModified(FileTableMap::COL_SUFFIX)) {
        ...
        if ($this->isColumnModified(FileTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'TIME';
        }
        if ($this->isColumnModified(FileTableMap::COL_STATUS)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FileTableMap::COL_HASH)) {
            $criteria->add(FileTableMap::COL_HASH, $this->hash);
        }
        if ($this->isColumnModified(FileTableMap::COL_SUFFIX)) {
            $criteria->add(FileTableMap::COL_SUFFIX, $this->suffix);
        }
        if ($this->isColumnModified(FileTableMap::COL_DESCRIPTION)) {
        ...
        if ($this->isColumnModified(FileTableMap::COL_TIME)) {
            $criteria->add(FileTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(FileTableMap::COL_STATUS)) {
            $criteria->add(FileTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(FileTableMap::COL_CREATED_AT)) {
